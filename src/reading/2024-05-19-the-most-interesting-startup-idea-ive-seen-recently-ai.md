---
title: "The most interesting startup idea I’ve seen recently: AI for&nbsp;epistemics"
url: "https://80000hours.org/2024/05/project-idea-ai-for-epistemics/"
source: "feedly"
sourceTitle: "80,000 Hours"
...
_This was originally posted on [benjamintodd.substack.com](https://benjamintodd.substack.com/p/the-most-interesting-startup-idea)._

If transformative AI [might come soon](https://80000hours.org/problem-profiles/artificial-intelligence/#when-can-we-expect-to-develop-transformative-AI) and you want to help that go well, one strategy you might adopt is building something useful that will improve as AI gets more capable.
...
Some of these judgement calls will need to be made under a lot of time pressure — especially if we’re seeing [100 years of technological progress in under 5](https://80000hours.org/podcast/episodes/tom-davidson-how-quickly-ai-could-transform-the-world/).
...
Better decision-making can also potentially help with all other cause areas, which is why [80,000 Hours recommends it as a cause area](https://80000hours.org/problem-profiles/improving-institutional-decision-making/) independent from AI.
...
In the short term, you can apply these systems to conventional problems, potentially in the for-profit sector, like finance. We seem to be just approaching the point where AI systems might be able to help (e.g. [a recent paper found GPT-4 was pretty good at forecasting](https://www.astralcodexten.com/p/mantic-monday-31124) if fine-tuned). Starting here allows you to gain scale, credibility and resources.

![](https://80000hours.org/wp-content/uploads/2024/05/Futuresearch-profits.png)
...
-   One example of a concrete proposal is using AI to make better forecasts or otherwise improve truthfinding in important domains. On the more qualitative side, we could imagine an AI “decision coach” or consultant that aims to augment human decision-making. Any techniques to make it easier to extract the truth from AI systems could also count, such as relevant kinds of interpretability research and the [AI debate](https://www.alignmentforum.org/tag/debate-ai-safety-technique-1) or [weak-to-strong generalisation](https://openai.com/index/weak-to-strong-generalization/) approaches to AI alignment.
...
-   [Future Search](https://futuresearch.ai/)
-   [Philip Tetlock’s Lab at UPenn](https://thedecisionlab.com/thinkers/political-science/philip-tetlock?ref=josephnoelwalker.com)
-   [Danny Halawi at UC Berkeley](https://www.astralcodexten.com/p/mantic-monday-31124)
...
-   [Mantic Monday 3/11/24](https://www.astralcodexten.com/p/mantic-monday-21924) and [2/19/24](https://www.astralcodexten.com/p/mantic-monday-21924) by Astral Codex Ten summarise some recent developments in this space.
-   [Project founder](https://80000hours.org/career-reviews/founder-impactful-organisations/) was written by me on 80,000 Hours with some general advice on entrepreneurial careers.
...
_I’m writing about AI, doing good and using research to have a nicer life. Subscribe to my Substack to [get all my posts](https://benjamintodd.substack.com/)._

The post [The most interesting startup idea I’ve seen recently: AI for epistemics](https://80000hours.org/2024/05/project-idea-ai-for-epistemics/) appeared first on [80,000 Hours](https://80000hours.org).
